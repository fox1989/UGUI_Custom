    ...
    public class CanvasScalerEditor : Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            if (serializedObject == null || serializedObject.targetObject == null)
                ...
                bIsPreset = serializedObject.targetObject is Component ? ((int)(serializedObject.targetObject as Component).gameObject.hideFlags == 93) : !AssetDatabase.Contains(serializedObject.targetObject);
        }
