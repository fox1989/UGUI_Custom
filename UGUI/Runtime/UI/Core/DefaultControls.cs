...
namespace UnityEngine.UI
{
    ...
    public static class DefaultControls
    {
        ...
        public static GameObject CreateGridLayout(Resources resources)
        {
            GameObject go = CreateUIElementRoot("GridLayout", s_ThickElementSize, typeof(GridLayoutGroup));
        ...
        public static GameObject CreateHorizontalLayout(Resources resources)
        {
            GameObject go = CreateUIElementRoot("HorizontalLayout", s_ThickElementSize, typeof(HorizontalLayoutGroup));
            RectTransform rectTransform = go.GetComponent<RectTransform>();
            rectTransform.sizeDelta = new Vector2(300, 200);
            return go;
        }
        ...
        public static GameObject CreateVerticalLayout(Resources resources)
        {
            GameObject go = CreateUIElementRoot("VerticalLayout", s_ThickElementSize, typeof(VerticalLayoutGroup));
            RectTransform rectTransform = go.GetComponent<RectTransform>();
            rectTransform.sizeDelta = new Vector2(300, 200);
            return go;
        }
